...
/**
 */
public class TopicMessageSubscriber implements IConsumer {

	private static final Logger logger = LoggerFactory.getLogger(TopicMessageSubscriber.class);
	...
	public TopicMessageSubscriber(ActiveMQConnectionFactory activeMQConnectionFactory) {
	...
	public QMessage receiveMessageSync(String destination, boolean isTransaction, long timeout) throws Exception {
		...
		try {
			...
			if (msg == null) {
//				logger.warn("######Can not receive any message");
				return null;
			}
			...
			if (msg instanceof TextMessage) {
				...
				logger.info("######Subscriber - CONTENT:" + qMessage.getContent());
			}
