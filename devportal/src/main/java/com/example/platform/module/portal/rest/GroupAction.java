...
import com.example.local.MyLocalJarInfo;
...
import com.example.platform.module.common.extend.entity.PageRecords;
import com.example.platform.module.common.extend.utils.TransformUtil;
...
public class GroupAction {
    ...
    @RequestMapping(value = "/runlocaljar", method = {RequestMethod.GET})
    @ResponseBody
    public ResponseResult runLocalJar() {
        MyLocalJarInfo myLocalJarInfo = new MyLocalJarInfo();

        String result = myLocalJarInfo.getFirstAction();
